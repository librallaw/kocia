                ...
                <div class="col-9">
                    ...
                    <nav>
						<ul class="cd-primary-nav">
							...
							<li><a href="https://1.envato.market/OAmnr" class="animated_link" target="_parent">Purchase Template</a></li>
						</ul>
					</nav>
					<!-- /menu -->
                </div>
        ...
        <div class="row no-gutters">
            <div class="col-lg-4">
                <div id="left_form">
                    ...
                    <h2>CORONAVIRUS <span>Health Questionnaire</span></h2>
                    <p>Help yourself in decision-making whether to seek professional medical advice or not.</p>
                    <a href="https://1.envato.market/OAmnr" class="btn_1 rounded yellow purchase" target="_parent">Purchase this template</a>
	                <a href="index.html#wizard_container" class="btn_1 rounded mobile_btn yellow">Start Now!</a>
                                ...
                                <div class="summary">
                                    ...
                                    <div class="text-center">
                                        <div class="form-group terms">
                                            <label class="container_check">Please accept our <a href="index.html#" data-toggle="modal" data-target="#terms-txt">Terms and conditions</a> before Submit
