					...
					<div class="col-md-12">
						<div class="card_dash1">
							<div class="card_dash_left1">
								...
								<h1>Jump Into Event Creation</h1>
							</div>
							<div class="card_dash_right1">
								<button class="create_btn_dash" onclick="window.location.href ='{{route
								("showCreateEvent")}}'">Create New Event</button>
							</div>
						</div>
					</div>					
				</div>
												...
												<tbody>
													...
													@foreach($events as $event)
														...
														<tr>
															...
															<td class="text-center">{{date("D, jS M, Y",
															$event->start_time)}}</td>
															<td class="text-center">{{$event->link}}</td>
															<td class="text-center">{{$event->created_at
															->diffForHumans()
															}}</td>
															<td class="text-center"><b
																		class="course_active">{{$event->status == 1
																		? "Active" : "Inactive"}}</b></td>
															<td class="text-center">
																<a href="{{route("showViewEvent",
																['quiz_code'=>$event->event_code])}}"
																   title="Edit"
																   class="gray-s"><i
																			class="uil
																 uil-eye"></i></a>
