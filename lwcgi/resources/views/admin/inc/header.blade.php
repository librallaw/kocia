    ...
    <div class="header_right">
        <ul>
            ...
            <li class="ui dropdown">
                <a href="/instructor_dashboard.html#" class="option_links"><i class='uil uil-envelope-alt'></i><span class="noti_count">3</span></a>
                <div class="menu dropdown_ms">
                    <a href="/instructor_dashboard.html#" class="channel_my item">
            ...
            <li class="ui dropdown">
                <a href="/instructor_dashboard.html#" class="option_links"><i class='uil uil-bell'></i><span class="noti_count">3</span></a>
            ...
            <li class="ui dropdown">
                <a href="/instructor_dashboard.html#" class="opts_account">
                ...
                <div class="menu dropdown_account">
                    ...
                    <div class="night_mode_switch__btn">
                        <a href="/instructor_dashboard.html#" id="night-mode" class="btn-night-mode">
