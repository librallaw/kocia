	...
	<div class="wrapper">
		<div class="sa4d25">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12">	
						<h2 class="st_title"><i class="uil uil-analysis"></i> Create News</h2>
					</div>					
				</div>				
				<div class="row">
					<div class="col-12">
						<div class="course_tabs_1">
							<div id="add-course-tab" class="step-app">
								...
								<form class="step-contents" action="{{route("doCreateNews")}}" method="post"
																...
																<div class="course_des_bg">
																	...
																	<div class="textarea_dt">
																		<div class="ui form swdh339">
																			<div class="field">
																				<textarea rows="5" name="news_content" id="summernote" placeholder="Insert your course description" required>{{old("news_content")}}</textarea>
																			</div>
																		</div>
																	</div>
																</div>
