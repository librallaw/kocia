            ...
            <div class="widget no-border pull-right sm-pull-none sm-text-center mt-10 mb-10 m-0">
              <ul class="list-inline">
                ...
                <li>
                  ...
                  <h5 class="font-14 m-0"> +(+234) 808-855-6350</h5>
                </li>
              </ul>
            </div>
          </div>  
          ...
          <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive">
            ...
            <ul class="pull-right flip hidden-sm hidden-xs">
              <li>
                ...
                <a class="btn btn-colored btn-flat bg-theme-color-2 text-white font-14 bs-modal-ajax-load mt-0 p-25 pr-15 pl-15" data-toggle="modal" data-target="#BSParentModal" href="ajax-load/reservation-form.html">My Account</a>
                <!-- Modal: Book Now End -->
              </li>
            </ul>
        ...
        <div class="rev_slider_wrapper">
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <!-- SLIDE 1 -->
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/sliders/1.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1"
                  data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/sliders/1.jpg"  alt=""  data-bgposition="center 10%" data-bgfit="cover"
              ...
              <!-- SLIDE 2 -->
              <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/sliders/2.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 2"
                  data-description="">
                <!-- MAIN IMAGE -->
                <img src="images/sliders/2.jpg"  alt=""  data-bgposition="center 40%" data-bgfit="cover"
                     data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
                <!-- LAYERS -->
    ...
    <section>
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-8">
              <h2 class="title font-42 text-theme-colored mt-30 mb-20">About LWCGI</h2>
              <p class="mb-20">The Vision of the LW CGI is to promote sustained spiritual and numerical growth in our churches, commensurate with the expectations of the Ministry and the urgency of our Kingdom Agenda. <br /><br />LW CGI will work with nominated Churches to deploy specific, strategic and
                tactical intervention for sustained growth; through focused and intense engagement with the Church leadership and brethren, by a select Team of Pastors equipped to produce the desired outcome.</p>
              <a class="btn btn-colored btn-theme-colored btn-lg text-uppercase font-13 mt-30"
                 href="index-mp-layout4.html#">Read More</a>
              <a class="btn btn-theme-color-2 btn-lg text-uppercase text-white font-13 mt-30" href="index-mp-layout4.html#">Register Now</a>
            </div>
            <div class="col-md-4">
              <div class="p-30 mt-0 bg-theme-colored">
                <h3 class="title-pattern mt-0"><span class="text-white">Register <span class="text-theme-color-2">Now
                </span></span></h3>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group mb-20">
                        <input placeholder="First Name" type="text" id="reservation_name" name="reservation_name"
                    ...
                    <div class="col-sm-6">
                      <div class="form-group mb-20">
                        <input placeholder="Last Name" type="text" id="reservation_names" name="reservation_name"
                               required="" class="form-control" aria-required="true">
                      </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group mb-20">
                        <input placeholder="Phone" type="text" id="phone" name="reservation_phone" class="form-control"
                    ...
                    <div class="col-sm-6">
                      <div class="form-group mb-20">
                        <input placeholder="Church" type="text" id="zone" name="zONE"
                    ...
                    <div class="col-sm-6">
                      <div class="form-group mb-20">
                        <input placeholder="Church" type="text" id="chuch" name="church"
                               class="form-control" required="" aria-required="true">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group mb-0 mt-10">
                        ...
                        <button type="submit" class="btn btn-colored btn-theme-color-2 text-white btn-lg btn-block" data-loading-text="Please wait...">Submit</button>
                      </div>
                    </div>
                  </div>
                </form>
              ...
              <div class="owl-carousel-4col">
                <div class="item ">
                  <div class="service-block bg-lighter">
                    <div class="thumb"> <img alt="featured project" src="images/courses/1.jpg" class="img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">$125</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                      <h4 class="line-bottom mb-10">Taking the lead </h4>
                ...
                <div class="item">
                  <div class="service-block bg-lighter">
                    <div class="thumb"> <img alt="featured project" src="images/courses/2.jpg"
                                             class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">$125</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                      <h4 class="line-bottom mb-10">Love Dimensions </h4>
                ...
                <div class="item">
                  <div class="service-block bg-lighter">
                    <div class="thumb"> <img alt="featured project" src="images/courses/3.jpg"
                                             class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">$125</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                      <h4 class="line-bottom mb-10">Leadership & Strategy</h4>
                ...
                <div class="item">
                  <div class="service-block bg-lighter">
                    <div class="thumb"> <img alt="featured project" src="images/courses/4.jpg"
                                             class="img-responsive img-fullwidth">
                    <h4 class="text-white mt-0 mb-0"><span class="price">$125</span></h4>
                    </div>
                    <div class="content text-left flip p-25 pt-0">
                      <h4 class="line-bottom mb-10">Discerning Spirit </h4>
    ...
    <section id="Teachers">
      <div class="container">
        <div class="section-title">
          <div class="row">
            <div class="col-md-12">
              <h2 class="text-uppercase text-theme-colored title line-bottom line-height-1 mb-0">Our <span class="text-theme-color-2 font-weight-400">Facilitators</span></h2>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="owl-carousel-4col">
              <div class="item">
                <div class="team-members maxwidth400">
                  <div class="team-thumb">
                    <img class="img-fullwidth" alt="" src="images/facilitators/1.jpg">
                  </div>
                  <div class="team-bottom-part border-bottom-theme-color-2-2px bg-lighter border-1px text-center p-10 pt-20 pb-10">
                    <h4 class="text-uppercase font-raleway font-weight-600 m-0"><a class="text-theme-color-2"
                                                                                   href="page-teachers-details.html">
                      Pastor Lanre Alabi</a></h4>
              ...
              <div class="item">
                <div class="team-members maxwidth400">
                  <div class="team-thumb">
                    <img class="img-fullwidth" alt="" src="images/facilitators/2.jpg">
                  </div>
                  <div class="team-bottom-part border-bottom-theme-color-2-2px bg-lighter border-1px text-center p-10 pt-20 pb-10">
                    <h4 class="text-uppercase font-raleway font-weight-600 m-0"><a class="text-theme-color-2"
                                                                                   href="page-teachers-details.html">Pastor Vale Odu-Thomas</a></h4>
              ...
              <div class="item">
                <div class="team-members maxwidth400">
                  <div class="team-thumb">
                    <img class="img-fullwidth" alt="" src="images/facilitators/3.jpeg">
                  </div>
                  <div class="team-bottom-part border-bottom-theme-color-2-2px bg-lighter border-1px text-center p-10 pt-20 pb-10">
                    <h4 class="text-uppercase font-raleway font-weight-600 m-0"><a class="text-theme-color-2"
                                                                                   href="page-teachers-details.html">Pastor Goke Adebayo</a></h4>
              ...
              <div class="item">
                <div class="team-members maxwidth400">
                  <div class="team-thumb">
                    <img class="img-fullwidth" alt="" src="images/facilitators/4.jpg">
                  </div>
                  <div class="team-bottom-part border-bottom-theme-color-2-2px bg-lighter border-1px text-center p-10 pt-20 pb-10">
                    <h4 class="text-uppercase font-raleway font-weight-600 m-0"><a class="text-theme-color-2" href="page-teachers-details.html">Evang Dr Eddy Owase</a></h4>
            ...
            <div class="owl-carousel-2col boxed" data-dots="true">
              <div class="item">
                <div class="testimonial pt-10">
                  ...
                  <div class="ml-100 ">
                    <h4 class="text-white mt-0">Thank God for the CGI, we have experienced growth like never before
                      after having strategic trainings with the CGI team. Glory !!!
                      .</h4>
                    <p class="author mt-20">- <span class="text-theme-color-2">Catherine Grace,</span> <small><em
                            class="text-gray-lightgray">CE Lagos Zone 3</em></small></p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimonial pt-10">
                  ...
                  <div class="ml-100 ">
                    <h4 class="text-white mt-0">We used to strugle to retain members in my church but now we have
                      experieved steady growth and and 50% increase in retaining our members
                      .</h4>
                    <p class="author mt-20">- <span class="text-theme-color-2">Mathew Zinkas,</span> <small><em
                            class="text-gray-lightgray">CE Abuja Region</em></small></p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimonial pt-10">
                  ...
                  <div class="ml-100 ">
                    <h4 class="text-white mt-0">Thank God for the CGI, we have experienced growth like never before
                      after having strategic trainings with the CGI team. Glory !!!</h4>
                    <p class="author mt-20">- <span class="text-theme-color-2">Daneile Benard,</span> <small><em
                            class="text-gray-lightgray">CE Port-harcourt zone 2</em></small></p>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="testimonial pt-10">
                  ...
                  <div class="ml-100 ">
                    <h4 class="text-white mt-0">We used to strugle to retain members in my church but now we have
                      experieved steady growth and and 50% increase in retaining our members.</h4>
                    <p class="author mt-20">- <span class="text-theme-color-2">Catherine Grace,</span> <small><em
                            class="text-gray-lightgray">CE Lagos Zone 1</em></small></p>
                  </div>
                </div>
              </div>
            </div> 
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="item">
                <article class="post clearfix maxwidth600 mb-sm-30">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> <img src="images/courses/4.jpg" alt="" class="img-responsive img-fullwidth"> </div>
              ...
              <div class="item">
                <article class="post clearfix maxwidth600 mb-sm-30">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> <img src="images/courses/3.jpg" alt=""
              ...
              <div class="item">
                <article class="post clearfix maxwidth600 mb-sm-30">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> <img src="images/courses/2.jpg" alt=""
                                                        class="img-responsive img-fullwidth"> </div>
                    <div class="entry-meta meta-absolute text-center pl-15 pr-15">
                    <div class="display-table">
                      <div class="display-table-cell">
              ...
              <div class="item">
                <article class="post clearfix maxwidth600 mb-sm-30">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> <img src="images/courses/1.jpg" alt=""
                                                        class="img-responsive img-fullwidth"> </div>
                    <div class="entry-meta meta-absolute text-center pl-15 pr-15">
                    <div class="display-table">
                      <div class="display-table-cell">
  ...
  <footer id="footer" class="footer divider layer-overlay overlay-dark-9" data-bg-img="images/bg/bg2.jpg">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list-inline mt-5">
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-phone text-theme-color-2 mr-5"></i> <a class="text-gray" href="#">(+234) 808-855-6350</a> </li>
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-envelope-o text-theme-color-2 mr-5"></i> <a class="text-gray" href="#">info@lwcgi.org</a> </li>
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-color-2 mr-5"></i> <a class="text-gray"
                                                                                                  href="#">www.lwcgi.org</a> </li>
            </ul>
          </div>
        </div>
    ...
    <div class="footer-bottom bg-black-333">
      <div class="container pt-20 pb-20">
        <div class="row">
          <div class="col-md-6">
            <p class="font-11 text-black-777 m-0">Copyright 2020 LWCGI - All Rights Reserved | Privacy Policy</p>
          </div>
