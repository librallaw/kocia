            ...
            <div class="container">
                <div class="ttm-topbar-content">
                    <ul class="top-contact text-left">
                        <li><i class="fa fa-map-marker"></i>5 Abdullahi Street, Akoka, Lagos</li>
                        <li><i class="fa fa-envelope-o"></i><a href="mailto:Info@kociasl.com">info@kociasl.com</a></li>
                        <li><i class="fa fa-envelope-o"></i>+234 803 849 5417</li>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="featured-icon-box left-icon style1 ttm-bgcolor-skincolor">
                            ...
                            <div class="featured-content"><!--  featured-content -->
                                ...
                                <div class="featured-desc"><!--  featured-desc -->
                                    <p>We Are offer only expert and professional advices</p>
                                </div>
                            </div>
                        </div><!--  featured-icon-box END -->
                    </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="section-title with-desc clearfix">
                            <div class="title-header">
                                <h5>About us</h5>
                                <h2 class="title">We Are Business <span>Enablers</span></h2>
                            </div>
                            <div class="title-desc">
                                <p>We are an IT consulting and solution provider company, that help clients design, build, support and manage their entire IT infrastructure. Kocia can help lead your organization forward with highly effective IT strategies and implement innovative solutions with our consultancy services</p>
                        ...
                        <div class="about-text-box fs-16">
                            <span>Call or Email to ask <a href="#" class="fw-500"><u>any question</u></a></span>
                            <strong class="fs-18">: +234 803 849 5417</strong> or <strong class="fs-18">info@kociasl.com</strong>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="position-relative res-991-mt-30">
                            ...
                            <div class="about-overlay-01">
                                <p class="mb-0">Excellence at its best.</p>
                            </div>
                        ...
                        <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                            ...
                            <div class="ttm-history-box-details">
                                ...
                                <div class="ttm-historybox-description" align="left"><!-- description  -->
                                   ...
                                   <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> DATA CENTERS</div>
                                   <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> SERVERS & STORAGE </div>
                                   <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content">  FIREWALL, SWITCHES, ROUTERS & WIRELESS DEVICES </div>
                        ...
                        <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                            ...
                            <div class="ttm-history-box-details">
                                ...
                                <div class="ttm-historybox-description" align="left">
                                    ...
                                    <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> DATA SECURITY</div>
                                    <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> APPLICATION SECURITY</div>
                        ...
                        <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                            ...
                            <div class="ttm-history-box-details">
                                ...
                                <div class="ttm-historybox-description" align="left"><!-- description  -->
                                    ...
                                    <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> IMPLEMENTATION</div>
                                    <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> CLOUD SUPPORT </div>
                                    <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> CLOUD SECURITY</div>
                        ...
                        <div class="ttm-history-box-wrapper"><!-- ttm-history-box-wrapper  -->
                            ...
                            <div class="ttm-history-box-details">
                                ...
                                <div class="ttm-historybox-description" align="left"><!-- description  -->
                                    ...
                                    <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> WEBSITE DEVELOPMENT</div>
                                    <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> WEB & MOBILE APP DEVELOPMENT </div>
                                    <div> <i class="fa fa-circle-o ttm-textcolor-skincolor"></i><span class="ttm-list-li-content"> INTEGRATION & PROCESS AUTOMATION</div>
                ...
                <div class="row portfolio-slide owl-carousel ttm-boxes-spacing-10px" data-item="5" data-nav="false" data-dots="false" data-auto="false">
                    <div class="col-lg ttm-box-col-wrapper">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            ...
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="images/portfolio/nin.jpg" alt="image">
                            </div><!-- featured-thumbnail end-->
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay">
                                <div class="featured-iconbox ttm-media-link"><!-- ttm-media-link -->
                                    <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" data-rel="prettyPhoto" href="images/portfolio/nin.jpg"><i class="ti
                                    ti-search"></i></a>
                            ...
                            <div class="featured-content">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5><a href="#">NIN verification Portal with AI</a></h5>
                                </div>
                            </div>
                    ...
                    <div class="col-lg ttm-box-col-wrapper">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <!-- featured-thumbnail -->
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="images/portfolio/360.jpg" alt="360 Pharmacy">
                            </div><!-- featured-thumbnail end-->
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay">
                                <div class="featured-iconbox ttm-media-link"><!-- ttm-media-link -->
                                    <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" data-rel="prettyPhoto" href="images/portfolio/360.jpg"><i class="ti ti-search"></i></a>
                                    <a href="#" class="ttm_link"><i class="ti ti-link"></i></a>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                            <div class="featured-content">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5><a href="#">360 Pharmacy correspondence</a></h5>
                                </div>
                            </div>
                        </div><!-- featured-thumbnail -->
                    </div>
                    <div class="col-lg ttm-box-col-wrapper">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <!-- featured-thumbnail -->
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="images/portfolio/partum.jpg" alt="image">
                            </div><!-- featured-thumbnail end-->
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay">
                                <div class="featured-iconbox ttm-media-link"><!-- ttm-media-link -->
                                    <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" data-rel="prettyPhoto" href="images/portfolio/partum.jpg"><i class="ti ti-search"></i></a>
                                    <a href="#" class="ttm_link"><i class="ti ti-link"></i></a>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                            <div class="featured-content">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5><a href="#">Partum gateway Savings</a></h5>
                                </div>
                            </div>
                        </div><!-- featured-thumbnail -->
                    </div>
                    <div class="col-lg ttm-box-col-wrapper">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <!-- featured-thumbnail -->
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="images/portfolio/cgi.jpg" alt="image">
                            </div><!-- featured-thumbnail end-->
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay">
                                <div class="featured-iconbox ttm-media-link"><!-- ttm-media-link -->
                                    <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" data-rel="prettyPhoto" href="images/portfolio/cgi.jpg"><i class="ti
                                    ti-search"></i></a>
                                    <a href="#" class="ttm_link"><i class="ti ti-link"></i></a>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                            <div class="featured-content">
                                <div class="featured-title"><!-- featured-title -->
                                    <h5><a href="#">CGI Training Portal</a></h5>
                                </div>
                            </div>
                        </div><!-- featured-thumbnail -->
                    </div>
                    <div class="col-lg ttm-box-col-wrapper">
                        ...
                        <div class="featured-imagebox featured-imagebox-portfolio style1">
                            <!-- featured-thumbnail -->
                            <div class="featured-thumbnail">
                                <img class="img-fluid lazyload" data-src="images/portfolio/jp.jpg" alt="image">
                            </div><!-- featured-thumbnail end-->
                            <!-- ttm-box-view-overlay -->
                            <div class="ttm-box-view-overlay">
                                <div class="featured-iconbox ttm-media-link"><!-- ttm-media-link -->
                                    <a class="ttm_prettyphoto ttm_image" data-gal="prettyPhoto[gallery1]" title="" data-rel="prettyPhoto" href="images/portfolio/jp.jpg"><i class="ti
                                    ti-search"></i></a>
                                    <a href="#" class="ttm_link"><i class="ti ti-link"></i></a>
                                </div>
                            </div><!-- ttm-box-view-overlay end-->
                ...
                <div class="row align-items-md-center">
                            ...
                            <div class="featured-icon-box left-icon icon-align-top">
                                ...
                                <div class="featured-content"><!--  featured-content -->
                                    <div class="featured-desc">
                                        <p>5 Abdullahi Street, Akoka, Lagos</p>
                                    </div>
                                </div>
                            </div><!--  featured-icon-box END -->
                        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 order-md-3">
                        <div class="text-sm-right">
                            <a class="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-icon-btn-left ttm-btn-color-white" href="mailto:info@kociasl.com" title=""> info@kociasl.com <i class="fa
                            fa-envelope-o"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                        <div class="widget widget_text  clearfix">
                            ...
                            <div class="textwidget widget-text">
                                We are an IT consulting and solution provider company, that help clients build, support and manage their entire IT infrastructure. Kocia can help lead your organization forward with highly effective IT strategies and implement innovative solutions with our consultancy services.
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                        <div class="widget link-widget clearfix">
                            ...
                            <ul id="menu-footer-services">
                                ...
                                <li><a href="#">Our recent Projects</a></li>
                                <li><a href="#">Contact Us</a></li>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                        <div class="widget flicker_widget clearfix">
                            ...
                            <div class="textwidget widget-text">
                                ...
                                <div class="social-iconss circle social-hover">
                                    <ul class="list-inline">
                                        <li class="social-facebook float-left"><a class="tooltip-top" target="_blank" href="#" data-tooltip="Facebook">&nbsp;&nbsp; <i class="fa fa-facebook"
                                                                                                                                                  aria-hidden="true"></i> </a></li>
                                        <li class="social-twitter float-left"><a class="tooltip-top" target="_blank" href="#" data-tooltip="Twitter">&nbsp;&nbsp; <i class="fa fa-twitter"
                                                                                                                                                         aria-hidden="true"></i> </a></li>
                                        <li class="social-flickr float-left"><a class=" tooltip-top" target="_blank" href="#" data-tooltip="flickr">&nbsp;&nbsp; <i class="fa fa-flickr"
                                                                                                                                                        aria-hidden="true"></i> </a></li>
                                        <li class="social-linkedin float-left"><a class=" tooltip-top" target="_blank" href="" data-tooltip="LinkedIn">&nbsp;&nbsp; <i class="fa fa-linkedin"
                                                                                                                                                           aria-hidden="true"></i> </a></li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="bottom-footer-text ttm-bgcolor-darkgrey ttm-textcolor-white">
            <div class="container">
                <div class="row copyright">
                    <div class="col-md-6">
                        <div class="">
                            <span>Copyright © <?php echo date("Y")?>&nbsp;<a href="/">Kocia</a>
                        </div>
                    </div>
