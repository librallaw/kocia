...
<meta name="description" content="Kocia – IT Solutions and Services" />
                        ...
                        <div class="site-header-menu-inner ttm-stickable-header">
                            <div class="container">
                                ...
                                <div class="site-branding">
                                    <a class="home-link" href="/" title="Kocia" rel="home">
                ...
                <rs-slides>
                    ...
                    <rs-slide data-key="rs-3" data-title="Slide" data-thumb="images/slides/slider-mainbg-003.jpg" data-anim="ei:d;eo:d;s:1000;r:0;t:fade;sl:0;">
                        ...
                        <rs-layer
                            ...
                            >organisation <strong class="ttm-textcolor-skincolor">forward</strong>
                        </rs-layer>
                        ...
                        <rs-layer
                            ...
                            ><img src="images/slides/13.png" alt="singl-image" width="578" height="564" data-no-retina>
                        </rs-layer>
                        <rs-layer
                        ...
                        <rs-layer
                            ...
                            > We are an IT consulting and solution provider company, that help clients build, support and <br />manage their entire IT infrastructure.
                        </rs-layer>
                        <rs-layer
                                        ...
                                        <div class="col-lg-11">
                                            <div class="spacing-5">
                                                ...
                                                <div class="section-title with-desc mb-40 clearfix">
                                                    <div class="title-header">
                                                        <h5>About Kocia</h5>
                                                        <h2 class="title">Trusted by clients + <span>Happy Customers</span></h2>
                                                    </div>
                                                    <div class="title-desc">
                                                        <p>We listen. We advise. We design, together. Happy customers and ongoing relationships are what we strive for. Success is measured by results, the most important thing being how our clients feel about their experience with us.</p>
                                                    </div>
                                                </div><!-- section title end -->
                                                <div class="row">
                                                    <div class="col-md-4">
                    ...
                    <div class="row"><!-- row -->
                        <div class="col-lg-6 offset-lg-3">
                            ...
                            <div class="section-title with-desc text-center clearfix">
                                <div class="title-header">
                                    <h5>Our Services</h5>
                                    <h2 class="title">We run all kinds of IT services with several years of <span>experience</span></h2>
                                </div>
                            </div><!-- section title end -->
                        </div>
                    </div>
            ...
            <div class="second-footer ttm-textcolor-white bg-img2">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                            <div class="widget widget_text clearfix"><div class="quicklink-box">
                                    <!--  featured-icon-box -->
            ...
            <div class="bottom-footer-text ttm-bgcolor-darkgrey ttm-textcolor-white">
                <div class="container">
                    <div class="row copyright">
                        <div class="col-md-6">
                            <div class="">
                                <span>Copyright © 2020&nbsp;<a href="#">Kocia</a></span>
                            </div>
                        </div>
                        <div class="col-md-6">
