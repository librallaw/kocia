				...
				<div class="col-md-8">
						...
						<div class="checkout-block">
							...
							@if(Auth::check())
								...
								<div class="alert alert-warning">If you are a guest, please click
									<a href="{{route("guest_givings")}}"><button class="btn btn-info">here</button></a>use the
										guest form to
									make your givings
								</div>
							@endif
...
<script>
    ...
    function submit_form(response) {
        ...
        $.ajax({
            ...
            url         : '/member/verify/payment', // the url where we want to POST
            data        : formData,
